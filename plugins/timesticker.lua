...
function run(msg, matches)
 local day = os.date("%M") * 2
local hash = 'imagepro:'..day..':'..msg.from.id
local is_imagepro = redis:get(hash)
if is_imagepro and not is_sudo(msg) then
return "اسپم نکنید|1دقیقه منتظر بمانید مجددا امتحان کنید"
